...
optional.add_argument("--temperature", type=float, help="Set momenta corresponding to a temperature T", default=500)
...
optional.add_argument("--steps",  type=int, help="number of steps in md", default=200000)
...
####Add constraint to sample TS with Hookean class
####
from ase.constraints import Hookean
c1 = Hookean(a1=12, a2=14, rt=1.21, k=2.)
c2 = Hookean(a1=13, a2=14, rt=1.21, k=2.)
