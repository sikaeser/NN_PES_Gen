...
#training procedure.
calc = NNCalculator(
    checkpoint="best-models-6748/6748_CPhOH_mp2_631g-1", #load the model you want to used
    atoms=atoms,
    charge=args.charge,
    F=128,
    K=64,
...
traj = Trajectory("meta_ClPhOH_scan.traj", "w")
...
angle = 0.5# atoms.get_dihedral(2, 3, 11, 12)
for i in range(360):
